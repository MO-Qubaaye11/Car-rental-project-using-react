...
const CarItem = (props) => {
  ...
  <div className="car_item">
    ...
    <div className="car_item-content mt-4">
        ...
        <h6 className='rent_price text-center mt-4'>${price}.00
            <span>/ Day</span>
        </h6>

        <div className="car_item-info d-flex align-items-center justify-content-between mt03 mb-4">
            <span className='d-flex align-items-center gap-1'>
                <i class="ri-car-line"></i> {model} </span>
            <span className='d-flex align-items-center gap-1'>
                <i class="ri-settings-2-line"></i> {automatic} </span>
            <span className='d-flex align-items-center gap-1'>
